...
//  RxMemo
//
//  Created by Sang Hyeon kim on 2023/03/04.
//
...
class CoreDateStorage: MemoStorageType {
    ...
    func memoList() -> RxSwift.Observable<[MemoSectionModel]> {
        return mainContext.rx
            .entities(Memo.self, sortDescriptors: [NSSortDescriptor(key: "insertDate", ascending: false)])
